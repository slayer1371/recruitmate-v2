        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
          ...
          <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2 ">
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Joey Zayszly</a>
                </h3>
                <span className="text-gray-500 dark:text-gray-400">
                  Founder, CEO
                </span>
                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
                  Brains and brawn behind the company&apos;s vision and strategy.
                </p>
            ...
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Richard Johnson</a>
                </h3>
                <span className="text-gray-500 dark:text-gray-400">CTO</span>
                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
                  All-American Sprinter at the University of Oklahoma
                </p>
                <ul className="flex space-x-4 sm:mt-0">
                  <li>
                    <a
            ...
            <div className="items-center w-full bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 px-0 py-8 md:col-span-2 md:max-w-lg mx-auto">
              ...
              <div className="p-5">
                <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Mrinal Sharma</a>
                </h3>
                <span className="text-gray-500 dark:text-gray-400">
                  Senior Front-end Developer
                </span>
                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
                  Mrinal drives the technical strategy of the RecruitMate
                  platform and brand.
                </p>
                <ul className="flex space-x-4 sm:mt-0">
                  <li>
